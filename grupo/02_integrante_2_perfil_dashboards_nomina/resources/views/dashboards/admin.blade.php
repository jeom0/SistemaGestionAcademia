...
<div class="flex flex-col gap-10 max-w-[1400px] mx-auto">
    ...
    <div class="flex justify-between items-center bg-white p-10 rounded-[2.5rem] border border-outline shadow-sm relative overflow-hidden">
        ...
        <div class="flex gap-4 relative z-10">
            ...
            <a href="{{ route('movements.create') }}" class="h-12 px-6 bg-primary text-white rounded-2xl font-bold flex items-center gap-2 hover:shadow-lg transition-all active:scale-[0.98]">
        ...
        <div class="p-8 bg-white border border-outline rounded-[2.5rem] shadow-premium hover-lift group">
            <div class="flex flex-col gap-6">
                ...
                <div class="flex flex-col">
                    ...
                    <span class="text-4xl font-black text-primary mt-2 tracking-tighter">${{ number_format(\App\Models\Movement::where('type', 'ingreso')->sum('amount'), 0) }}</span>
                </div>
            </div>
        </div>
        ...
        <div class="p-8 bg-white border border-outline rounded-[2.5rem] shadow-premium hover-lift group">
            <div class="flex flex-col gap-6">
                ...
                <div class="flex flex-col">
                    ...
                    <span class="text-4xl font-black text-blue-600 mt-2 tracking-tighter">${{ number_format(\App\Models\Movement::where('type', 'egreso')->sum('amount'), 0) }}</span>
                </div>
            </div>
        </div>
    </div>
