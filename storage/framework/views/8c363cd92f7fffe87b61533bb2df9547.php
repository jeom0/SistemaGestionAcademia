        ...
        <div class="lg:col-span-1 bg-white border border-outline rounded-[2.5rem] p-10 shadow-premium flex flex-col gap-8">
            ...
            <div class="flex flex-col gap-6">
                <div class="flex justify-between items-center">
                    ...
                    <span class="text-lg font-black text-primary">+$<?php echo e(number_format($ingresos, 2)); ?></span>
                </div>
                <div class="flex justify-between items-center">
                    <span class="text-sm font-bold text-on-surface-variant">Egresos Totales</span>
                    <span class="text-lg font-black text-red-600">-$<?php echo e(number_format($egresos, 2)); ?></span>
                </div>
                <div class="flex justify-between items-center pt-6 border-t border-outline">
                    ...
                    <span class="text-2xl font-black <?php echo e($balance >= 0 ? 'text-primary' : 'text-red-600'); ?>">$<?php echo e(number_format($balance, 2)); ?></span>
                </div>
            </div>
                ...
                <table class="w-full text-left">
                    ...
                    <tbody class="divide-y divide-outline">
                        ...
                        <tr class="hover:bg-surface transition-all group">
                            ...
                            <td class="px-8 py-5 text-sm font-black text-right <?php echo e($m->type === 'ingreso' ? 'text-primary' : 'text-red-600'); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\PC\Desktop\conduser\resources\views/reports/index.blade.php ENDPATH**/ ?>