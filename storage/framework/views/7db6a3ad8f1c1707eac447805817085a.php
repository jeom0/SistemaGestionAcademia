...
<div class="flex flex-col gap-10 max-w-[1400px] mx-auto">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 bg-white p-6 md:p-10 rounded-[2rem] md:rounded-[2.5rem] border border-outline shadow-sm relative overflow-hidden">
        ...
        <div class="flex flex-wrap gap-3 relative z-10 w-full md:w-auto">
            ...
            <a href="<?php echo e(route('movements.create')); ?>" class="h-12 px-6 bg-primary text-white rounded-2xl font-bold flex items-center justify-center gap-2 hover:shadow-lg transition-all active:scale-[0.98] flex-1 sm:flex-none">
        ...
        <div class="p-8 bg-white border border-outline rounded-[2.5rem] shadow-premium hover-lift group">
            <div class="flex flex-col gap-6">
                ...
                <div class="flex flex-col">
                    ...
                    <span class="text-4xl font-black text-secondary mt-2 tracking-tighter"><?php echo e(\App\Models\Movement::where('user_id', auth()->id())->where('status', 'pendiente')->count()); ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="p-8 bg-white border border-outline rounded-[2.5rem] shadow-premium hover-lift group">
            <div class="flex flex-col gap-6">
                ...
                <div class="flex flex-col">
                    ...
                    <span class="text-4xl font-black text-primary mt-2 tracking-tighter">$<?php echo e(number_format(\App\Models\Movement::where('user_id', auth()->id())->where('type', 'ingreso')->sum('amount'), 0)); ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="p-8 bg-white border border-outline rounded-[2.5rem] shadow-premium hover-lift group">
            <div class="flex flex-col gap-6">
                ...
                <div class="flex flex-col">
                    ...
                    <span class="text-4xl font-black text-blue-600 mt-2 tracking-tighter">$<?php echo e(number_format(\App\Models\Movement::where('user_id', auth()->id())->where('type', 'egreso')->sum('amount'), 0)); ?></span>
                </div>
            </div>
        </div>
    </div>
