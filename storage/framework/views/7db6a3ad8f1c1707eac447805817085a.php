...
<div class="flex flex-col gap-10 max-w-[1400px] mx-auto">
    ...
    <div class="flex justify-between items-center bg-white p-10 rounded-[2.5rem] border border-outline shadow-sm relative overflow-hidden">
        <div class="relative z-10 flex flex-col gap-2">
            <h1 class="text-4xl font-black text-secondary tracking-tight">Panel de Administración</h1>
            <p class="text-on-surface-variant font-medium">Gestión contable y financiera de la flota.</p>
        </div>
        <div class="flex gap-4 relative z-10">
            ...
            <a href="<?php echo e(route('movements.create')); ?>" class="h-12 px-6 bg-primary text-white rounded-2xl font-bold flex items-center gap-2 hover:shadow-lg transition-all active:scale-[0.98]">
        ...
        <div class="p-8 bg-white border border-outline rounded-[2.5rem] shadow-premium hover-lift group">
            <div class="flex flex-col gap-6">
                ...
                <div class="flex flex-col">
                    ...
                    <span class="text-4xl font-black text-primary mt-2 tracking-tighter">$<?php echo e(number_format(\App\Models\Movement::where('type', 'ingreso')->sum('amount'), 0)); ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="p-8 bg-white border border-outline rounded-[2.5rem] shadow-premium hover-lift group">
            <div class="flex flex-col gap-6">
                ...
                <div class="flex flex-col">
                    ...
                    <span class="text-4xl font-black text-blue-600 mt-2 tracking-tighter">$<?php echo e(number_format(\App\Models\Movement::where('type', 'egreso')->sum('amount'), 0)); ?></span>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <form action="<?php echo e(route('movements.store')); ?>" method="POST" class="flex flex-col gap-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div class="flex flex-col gap-2">
                                ...
                                <input type="date" name="date" value="<?php echo e(date('Y-m-d')); ?>" class="w-full h-14 px-5 rounded-2xl bg-surface-variant/30 border border-outline focus:bg-white focus:border-primary focus:ring-4 focus:ring-primary/5 transition-all text-secondary font-medium" required/>
                            </div>
                            <div class="flex flex-col gap-2">
        ...
        <div class="flex flex-col gap-8">
            <div class="bg-white border border-outline rounded-[2.5rem] shadow-sm overflow-hidden flex flex-col hover-lift">
                ...
                <div class="p-8">
                    <div class="flex flex-col gap-8">
                        <?php
                            $recent = \App\Models\Movement::orderBy('created_at', 'desc')->take(5)->get();
                        ?>
                        <?php $__currentLoopData = $recent; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center justify-between group">
                                <div class="flex items-center gap-4">
                                    <div class="w-10 h-10 rounded-xl <?php echo e($m->type === 'ingreso' ? 'bg-emerald-50 text-primary' : 'bg-blue-50 text-blue-600'); ?> flex items-center justify-center shrink-0">
                                        <span class="material-symbols-outlined text-[20px]"><?php echo e($m->type === 'ingreso' ? 'add' : 'remove'); ?></span>
                                    </div>
                                ...
                                <span class="text-sm font-black <?php echo e($m->type === 'ingreso' ? 'text-primary' : 'text-blue-600'); ?>">
                    ...
                    <a href="<?php echo e(route('movements.index')); ?>" class="mt-10 w-full h-12 border border-outline rounded-2xl flex items-center justify-center text-xs font-black text-on-surface-variant uppercase tracking-widest hover:bg-surface-variant transition-all">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mariapazpelaezrestrepo/Documents/Proyectos Desarrollapp/conduser/resources/views/dashboards/admin.blade.php ENDPATH**/ ?>