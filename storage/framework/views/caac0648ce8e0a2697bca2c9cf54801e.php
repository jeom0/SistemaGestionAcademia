<?php $__env->startSection('title', 'Mis Gastos'); ?>
...
<div class="flex flex-col gap-10 max-w-[1400px] mx-auto">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 bg-white p-6 md:p-10 rounded-[2rem] md:rounded-[2.5rem] border border-outline shadow-sm relative overflow-hidden">
        ...
        <div class="flex flex-wrap gap-3 relative z-10 w-full md:w-auto">
            <a href="<?php echo e(route('movements.index')); ?>" class="h-12 px-6 bg-white border border-outline text-secondary rounded-2xl font-bold hover:bg-surface-variant transition-all flex items-center justify-center gap-2 flex-1 sm:flex-none">
        ...
        <div class="p-8 bg-white border border-outline rounded-[2.5rem] shadow-premium hover-lift group">
            <div class="flex flex-col gap-6">
                ...
                <div class="flex flex-col">
                    ...
                    <span class="text-4xl font-black text-secondary mt-2 tracking-tighter"><?php echo e(auth()->user()->movements()->where('status', 'pendiente')->count()); ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="p-8 bg-white border border-outline rounded-[2.5rem] shadow-premium hover-lift group">
            <div class="flex flex-col gap-6">
                ...
                <div class="flex flex-col">
                    ...
                    <span class="text-4xl font-black text-blue-600 mt-2 tracking-tighter">$<?php echo e(number_format(auth()->user()->movements()->where('type', 'egreso')->sum('amount'), 0)); ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="p-8 bg-gradient-to-br from-amber-500 to-amber-600 border border-amber-400/20 rounded-[2.5rem] shadow-2xl shadow-amber-500/20 hover-lift group text-white">
            <div class="flex flex-col gap-6">
                ...
                <div class="flex flex-col">
                    ...
                    <span class="text-4xl font-black mt-2 tracking-tighter">$<?php echo e(number_format(auth()->user()->movements()->whereDate('date', today())->sum('amount'), 0)); ?></span>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <?php $__currentLoopData = $recent; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center justify-between group">
                                ...
                                <span class="text-sm font-black text-blue-600">
                                    -$<?php echo e(number_format($m->amount, 0)); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mariapazpelaezrestrepo/Documents/Proyectos Desarrollapp/conduser/resources/views/dashboards/collaborator.blade.php ENDPATH**/ ?>