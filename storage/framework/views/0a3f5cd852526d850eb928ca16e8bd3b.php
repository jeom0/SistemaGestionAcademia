                ...
                <tbody class="divide-y divide-outline">
                    <?php $__empty_1 = true; $__currentLoopData = $logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-primary/[0.02] transition-all">
                            <td class="px-8 py-6">
                                <span class="text-sm font-bold text-secondary"><?php echo e($log->created_at->format('d/m/Y H:i:s')); ?></span>
                            </td>
                            <td class="px-8 py-6">
                                <div class="flex items-center gap-3">
                                    ...
                                    <span class="text-sm font-bold text-secondary"><?php echo e($log->user->name ?? 'Sistema'); ?></span>
                                </div>
                            </td>
                            <td class="px-8 py-6">
                                <span class="px-4 py-1 rounded-full text-[10px] font-black uppercase tracking-widest <?php echo e($log->action === 'created' ? 'bg-emerald-100 text-primary' : ($log->action === 'updated' ? 'bg-blue-100 text-blue-700' : 'bg-red-100 text-red-700')); ?>">
                                    <?php echo e($log->action); ?>

                                </span>
                            </td>
                            <td class="px-8 py-6">
                                <span class="text-sm text-on-surface-variant font-medium"><?php echo e($log->details); ?></span>
                            </td>
                        </tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\PC\Desktop\conduser\resources\views/audit/index.blade.php ENDPATH**/ ?>