...
<div class="min-h-screen flex antialiased" x-data="{ helpModalOpen: false }">
    ...
    <div class="hidden lg:flex w-[55%] relative flex-col items-center justify-center overflow-hidden border-r border-outline bg-cover bg-center" style="background-image: url('<?php echo e(asset('images/login_bg.png')); ?>');">
            ...
            <form action="<?php echo e(route('login')); ?>" method="POST" class="flex flex-col gap-8">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <div class="relative group">
                        <input class="w-full h-14 px-5 rounded-2xl bg-white border border-outline text-secondary focus:outline-none focus:border-primary focus:ring-4 focus:ring-primary/5 transition-all <?php $__errorArgs = ['email'];
...
unset($__errorArgs, $__bag); ?>" 
                               id="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="Ingresa su usuario" type="email" required autofocus/>
                    </div>
...
$message = $__bag->first($__errorArgs[0]); ?>
                        <span class="text-xs text-red-600 mt-1 ml-1 font-medium"><?php echo e($message); ?></span>
                    <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex flex-col gap-2" x-data="{ showPassword: false }">
                    ...
                    <div class="relative group">
                        <input class="w-full h-14 px-5 pr-14 rounded-2xl bg-white border border-outline text-secondary focus:outline-none focus:border-primary focus:ring-4 focus:ring-primary/5 transition-all <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex flex-col gap-6 mt-4">
                    ...
                    <div class="text-center">
                        <a href="<?php echo e(route('password.request')); ?>" class="text-[13px] font-bold text-on-surface-variant hover:text-primary transition-colors">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mariapazpelaezrestrepo/Documents/Proyectos Desarrollapp/conduser/resources/views/auth/login.blade.php ENDPATH**/ ?>