<?php $__env->startSection('title', 'Gestión de Comisiones'); ?>
...
<div class="flex flex-col gap-10">
    ...
    <div class="bg-white border border-outline rounded-[3rem] shadow-premium overflow-hidden hover-lift">
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-outline">
                    <?php $__empty_1 = true; $__currentLoopData = $comisiones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-primary/[0.02] transition-all">
                            ...
                            <td class="px-8 py-6 text-right text-sm font-black text-primary">+$<?php echo e(number_format($m->amount, 0)); ?></td>
        ...
        <?php if($comisiones->hasPages()): ?>
            <div class="p-8 border-t border-outline">
                <?php echo e($comisiones->links()); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\PC\Desktop\conduser\resources\views/payroll/comisiones.blade.php ENDPATH**/ ?>