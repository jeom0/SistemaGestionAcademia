        ...
        <div class="bg-white border border-outline rounded-[2.5rem] p-10 shadow-premium hover-lift group">
            <div class="flex flex-col gap-8">
                ...
                <div class="flex flex-col">
                    <h3 class="text-xl font-black text-secondary uppercase tracking-tight"><?php echo e($account->associated_to); ?></h3>
                ...
                <div class="pt-6 border-t border-outline flex items-end justify-between">
                    <span class="text-4xl font-black <?php echo e($account->balance >= 0 ? 'text-primary' : 'text-red-600'); ?>">
                        $<?php echo e(number_format($account->balance, 2)); ?>

                    </span>
                    <a href="<?php echo e(route('movements.index', ['associated_to' => $account->associated_to])); ?>" class="w-10 h-10 rounded-xl bg-surface-variant flex items-center justify-center text-secondary hover:bg-primary hover:text-white transition-all">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\PC\Desktop\conduser\resources\views/accounts/index.blade.php ENDPATH**/ ?>